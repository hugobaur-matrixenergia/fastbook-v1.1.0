...
# CONTRATOS_WBC_CSV = r'C:\Users\hugo.baur\Matrix comercializadora de energia elétrica LTDA\Gestão de Projetos - Portfolio - Operação\contratos_wbc.csv'
#
# CONTRATOS_CSV = r'C:\Users\hugo.baur\Matrix comercializadora de energia elétrica LTDA\Gestão de Projetos - Portfolio - Operação\contratos.csv'
# ACERTOS_CSV = r'C:\Users\hugo.baur\Matrix comercializadora de energia elétrica LTDA\Gestão de Projetos - Portfolio - Operação\tabAcertos.csv'
# JUROS_CSV = r'C:\Users\hugo.baur\Matrix comercializadora de energia elétrica LTDA\Gestão de Projetos - Portfolio - Operação\tabJuros.csv'
# INFLACAO_CSV = r'C:\Users\hugo.baur\Matrix comercializadora de energia elétrica LTDA\Gestão de Projetos - Portfolio - Operação\tabInflacao.csv'
# MKT_CSV = r'C:\Users\hugo.baur\Matrix comercializadora de energia elétrica LTDA\Gestão de Projetos - Portfolio - Operação\tabMKT.csv'
# MARCACAO_CSV = r'C:\Users\hugo.baur\Matrix comercializadora de energia elétrica LTDA\Gestão de Projetos - Portfolio - Operação\tabMarcacao.csv'

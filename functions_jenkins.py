...
PATH = r"C:\Users\sysadmin\Matrix comercializadora de energia elétrica LTDA\Gestão de Projetos - Portfolio - Operação\FastBook_Otimizada_v2.xlsm"
# PATH = os.environ['USERPROFILE'] + r'\Matrix comercializadora de energia elétrica LTDA\Gestão de Projetos - Portfolio - Operação\FastBook_Otimizada_v2.xlsm'

CONTRATOS_WBC_CSV = r'C:\Users\sysadmin\Matrix comercializadora de energia elétrica LTDA\Gestão de Projetos - Portfolio - Operação\contratos_wbc.csv'
#
CONTRATOS_CSV = r'C:\Users\sysadmin\Matrix comercializadora de energia elétrica LTDA\Gestão de Projetos - Portfolio - Operação\contratos.csv'
ACERTOS_CSV = r'C:\Users\sysadmin\Matrix comercializadora de energia elétrica LTDA\Gestão de Projetos - Portfolio - Operação\tabAcertos.csv'
JUROS_CSV = r'C:\Users\sysadmin\Matrix comercializadora de energia elétrica LTDA\Gestão de Projetos - Portfolio - Operação\tabJuros.csv'
INFLACAO_CSV = r'C:\Users\sysadmin\Matrix comercializadora de energia elétrica LTDA\Gestão de Projetos - Portfolio - Operação\tabInflacao.csv'
MKT_CSV = r'C:\Users\sysadmin\Matrix comercializadora de energia elétrica LTDA\Gestão de Projetos - Portfolio - Operação\tabMKT.csv'
MARCACAO_CSV = r'C:\Users\sysadmin\Matrix comercializadora de energia elétrica LTDA\Gestão de Projetos - Portfolio - Operação\tabMarcacao.csv'

# CONTRATOS_WBC_CSV = os.environ['USERPROFILE'] + r'\Matrix comercializadora de energia elétrica LTDA\Gestão de Projetos - Portfolio - Operação\contratos_wbc.csv'
# CONTRATOS_CSV = os.environ['USERPROFILE'] + r'\Matrix comercializadora de energia elétrica LTDA\Gestão de Projetos - Portfolio - Operação\contratos.csv'
# ACERTOS_CSV = os.environ['USERPROFILE'] + r'\Matrix comercializadora de energia elétrica LTDA\Gestão de Projetos - Portfolio - Operação\tabAcertos.csv'
# JUROS_CSV = os.environ['USERPROFILE'] + r'\Matrix comercializadora de energia elétrica LTDA\Gestão de Projetos - Portfolio - Operação\tabJuros.csv'
# INFLACAO_CSV = os.environ['USERPROFILE'] + r'\Matrix comercializadora de energia elétrica LTDA\Gestão de Projetos - Portfolio - Operação\tabInflacao.csv'
# MKT_CSV = os.environ['USERPROFILE'] + r'\Matrix comercializadora de energia elétrica LTDA\Gestão de Projetos - Portfolio - Operação\tabMKT.csv'
# MARCACAO_CSV = os.environ['USERPROFILE'] + r'\Matrix comercializadora de energia elétrica LTDA\Gestão de Projetos - Portfolio - Operação\tabMarcacao.csv'
...
def tab_inflacao_cenario(PATH):
    ...
    df_inflacao_cenario = df_inflacao_cenario.rename(columns=df_inflacao_cenario.iloc[0]).drop(
        df_inflacao_cenario.index[0])
    df_inflacao_cenario = df_inflacao_cenario.dropna(axis=1, how='all')
    df_inflacao_cenario.columns = ['CHAVE', 'CENARIO', 'MES', 'ANO', 'IPCA', 'REALIZADO_IPCA', 'MENSAL_IPCA',
                                   'CORRECAO', 'IGPM', 'REALIZADO_IGPM', 'MENSAL_IGPM']
    end_time = datetime.datetime.now()
    exec_time = end_time - init_time
    tempo_exec = []
    ...
    for data in dates:
        ...
        if data_inteira < data_ccee:
            ...
            row.append(['BASE', data_split[0], data_split[1], 'SUL', 'Convencional', s_pld_publicado['Value'].values[0],
                        ...
                        s_pld_publicado['Value'].values[0], s_pld_publicado['Value'].values[0]])
            row.append(
                ['BASE', data_split[0], data_split[1], 'SUL', 'Incentivada-0%', s_pld_publicado['Value'].values[0],
                 s_pld_publicado['Value'].values[0], s_pld_publicado['Value'].values[0],
                 s_pld_publicado['Value'].values[0], s_pld_publicado['Value'].values[0]])
            row.append(
            ...
            row.append(
                ['BASE', data_split[0], data_split[1], 'SUL', 'Incentivada-CQ50%', s_pld_publicado['Value'].values[0],
                 ...
                 s_pld_publicado['Value'].values[0], s_pld_publicado['Value'].values[0]])
            row.append(
                ['BASE', data_split[0], data_split[1], 'SUL', 'Incentivada-y', s_pld_publicado['Value'].values[0],
                 s_pld_publicado['Value'].values[0], s_pld_publicado['Value'].values[0],
                 s_pld_publicado['Value'].values[0], s_pld_publicado['Value'].values[0]])
        ...
        if data_inteira >= data_ccee:
            ...
            row.append(['BASE', data_split[0], data_split[1], 'SE/CO', 'Convencional', se['Value'].values[0],
                        se['Value'].values[0]+ agio_se['Value'].values[0], (inflacao['CORRECAO'].values[0] * (se['Value'].values[0]+ agio_se['Value'].values[0])),
                        se['Value'].values[0]+ agio_se['Value'].values[0], (inflacao['CORRECAO'].values[0] * (se['Value'].values[0]+ agio_se['Value'].values[0]))])
            row.append(
            ...
            row.append(['BASE', data_split[0], data_split[1], 'SUL', 'Convencional', s['Value'].values[0],
                        s['Value'].values[0] + agio_s['Value'].values[0],
                        (inflacao['CORRECAO'].values[0] * (s['Value'].values[0] + agio_s['Value'].values[0])),
                        s['Value'].values[0] + agio_s['Value'].values[0],
                        (inflacao['CORRECAO'].values[0] * (s['Value'].values[0] + agio_s['Value'].values[0]))])
            ...
            row.append(['BASE', data_split[0], data_split[1], 'NE', 'Convencional', ne['Value'].values[0],
                        ne['Value'].values[0] + agio_ne['Value'].values[0],
                        (inflacao['CORRECAO'].values[0] * (ne['Value'].values[0] + agio_ne['Value'].values[0])),
                        ne['Value'].values[0] + agio_ne['Value'].values[0],
                        (inflacao['CORRECAO'].values[0] * (ne['Value'].values[0] + agio_ne['Value'].values[0]))])
            ...
            row.append(['BASE', data_split[0], data_split[1], 'NORTE', 'Convencional', n['Value'].values[0],
                        n['Value'].values[0] + agio_n['Value'].values[0],
                        (inflacao['CORRECAO'].values[0] * (n['Value'].values[0] + agio_n['Value'].values[0])),
                        n['Value'].values[0] + agio_n['Value'].values[0],
                        (inflacao['CORRECAO'].values[0] * (n['Value'].values[0] + agio_n['Value'].values[0]))])
            row.append(
...
def tab_mkt_anual(tabMarcacao_df, df_inflacao_cenario, data_ini, data_fim):
    ...
    for data in dates:
        ...
        row.append(['BASE', data_split[0], data_split[1], 'SE/CO', 'Convencional', se['Value'].values[0],
                    se['Value'].values[0] + agio_se['Value'].values[0],
                    (inflacao['CORRECAO'].values[0] * (se['Value'].values[0] + agio_se['Value'].values[0])),
                    se['Value'].values[0] + agio_se['Value'].values[0],
                    (inflacao['CORRECAO'].values[0] * (se['Value'].values[0] + agio_se['Value'].values[0]))])
        row.append(
            ['BASE', data_split[0], data_split[1], 'SE/CO', 'Incentivada-0%', se['Value'].values[0], fixo_se_i0,
...
def tab_contratos_nova():
    ...
    df_contratos = pd.read_sql(
        ...
        from [Ufo_Etrm_matrix].[dbo].[VW_CE_EXPORTAR_CONTRATOS_MATRIX_FAST_MANAGEMENT] AS a
...
def tab_contratos_nova_metricas(df1, df2, df_final):
    ...
    df3['MTM_Value'] = np.where(df3['Movimentacao'] == 'Compra',
                                ((df3['Valor_MKT'] - df3['Valor_MWh_Calc']) * df3['QuantAtualizada']),
                                (df3['Valor_MWh_Calc'] - df3['Valor_MKT']) * df3['QuantAtualizada'])
    ...
    df4['Vencimento'] = pd.to_datetime(df4['Vencimento']).dt.date
...
def guarda_dados_historicos():
    ...
    base_contratos_final_ultima_data(df)
